...
var register_vue_1 = require("@/account/register/register.vue");
var register_service_1 = require("@/account/register/register.service");
...
describe('Register Component', function () {
    var wrapper;
    var register;
    var filledRegisterAccount = { email: 'jhi@pster.net', langKey: 'en', login: 'jhi', password: 'jhipster' };
    beforeEach(function () {
        axiosStub.get.resolves({});
        axiosStub.post.reset();
        wrapper = (0, test_utils_1.shallowMount)(register_vue_1.default, {
            store: store,
            i18n: i18n,
            localVue: localVue,
            provide: {
                registerService: function () { return new register_service_1.default(); },
    ...
    it('should open login modal when asked to', function () {
        var called = false;
    ...
    it('should register when password match', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    register.register();
                    return [4 /*yield*/, register.$nextTick()];
                case 1:
                    _a.sent();
                    expect(axiosStub.post.calledWith('api/register', { email: 'jhi@pster.net', langKey: 'en', login: 'jhi', password: 'jhipster' })).toBeTruthy();
    ...
    it('should register when password match but throw error when login already exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    error = { response: { status: 400, data: { type: constants_1.LOGIN_ALREADY_USED_TYPE } } };
    ...
    it('should register when password match but throw error when email already used', function () { return __awaiter(void 0, void 0, void 0, function () {
        var error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should register when password match but throw error', function () { return __awaiter(void 0, void 0, void 0, function () {
        var error;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    error = { response: { status: 400, data: { type: 'unknown' } } };
                    axiosStub.post.rejects(error);
                    register.registerAccount = filledRegisterAccount;
                    register.confirmPassword = filledRegisterAccount.password;
                    register.register();
