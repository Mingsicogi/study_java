...
var reset_password_init_vue_1 = require("@/account/reset-password/init/reset-password-init.vue");
...
describe('Reset Component Init', function () {
    var wrapper;
    var resetPasswordInit;
    beforeEach(function () {
        axiosStub.post.reset();
        wrapper = (0, test_utils_1.shallowMount)(reset_password_init_vue_1.default, {
            i18n: i18n,
            localVue: localVue,
        });
        resetPasswordInit = wrapper.vm;
    });
    it('should reset request be a success', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // When
                    return [4 /*yield*/, resetPasswordInit.requestReset()];
                case 1:
                    // When
                    _a.sent();
                    // Then
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, resetPasswordInit.$nextTick()];
                case 1:
                    _a.sent();
                    // Then
