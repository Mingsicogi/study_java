...
var gnid_details_vue_1 = require("@/entities/gnid/gnid-details.vue");
...
describe('Component Tests', function () {
    describe('Gnid Management Detail Component', function () {
        var wrapper;
        var comp;
        var gnidServiceStub;
        beforeEach(function () {
            gnidServiceStub = sinon_1.default.createStubInstance(gnid_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(gnid_details_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router_1.default,
                provide: { gnidService: function () { return gnidServiceStub; }, alertService: function () { return new alert_service_1.default(); } },
            });
            comp = wrapper.vm;
        });
