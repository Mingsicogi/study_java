...
var gnid_update_vue_1 = require("@/entities/gnid/gnid-update.vue");
...
describe('Component Tests', function () {
    describe('Gnid Management Update Component', function () {
        var wrapper;
        var comp;
        var gnidServiceStub;
        beforeEach(function () {
            gnidServiceStub = sinon_1.default.createStubInstance(gnid_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(gnid_update_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router,
                provide: {
                    gnidService: function () { return gnidServiceStub; },
                    alertService: function () { return new alert_service_1.default(); },
                    gameService: function () {
                        return sinon_1.default.createStubInstance(game_service_1.default, {
                            retrieve: sinon_1.default.stub().resolves({}),
                        });
                    },
                    nidService: function () {
                        return sinon_1.default.createStubInstance(nid_service_1.default, {
                            retrieve: sinon_1.default.stub().resolves({}),
                        });
                    },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            // WHEN
                            comp.beforeRouteEnter({ params: { gnidId: 123 } }, null, function (cb) { return cb(comp); });
                            return [4 /*yield*/, comp.$nextTick()];
                        case 1:
                            _a.sent();
                            // THEN
