...
var gnid_model_1 = require("@/shared/model/gnid.model");
var error = {
    response: {
        status: null,
        data: {
...
describe('Service Tests', function () {
    describe('Gnid Service', function () {
        var service;
        var elemDefault;
        beforeEach(function () {
            service = new gnid_service_1.default();
            elemDefault = new gnid_model_1.Gnid(123, 0, 'AAAAAAA');
        });
        describe('Service methods', function () {
            ...
            it('should create a Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should not create a Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should update a Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var returnedFromService, expected;
                return __generator(this, function (_a) {
                    returnedFromService = Object.assign({
                        gnid: 1,
            ...
            it('should not update a Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should partial update a Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var patchObject, returnedFromService, expected;
                return __generator(this, function (_a) {
                    patchObject = Object.assign({}, new gnid_model_1.Gnid());
            ...
            it('should not partial update a Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should return a list of Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var returnedFromService, expected;
                return __generator(this, function (_a) {
                    returnedFromService = Object.assign({
                        gnid: 1,
            ...
            it('should not return a list of Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    axiosStub.get.rejects(error);
                    return [2 /*return*/, service
                            .retrieve()
            ...
            it('should delete a Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should not delete a Gnid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
