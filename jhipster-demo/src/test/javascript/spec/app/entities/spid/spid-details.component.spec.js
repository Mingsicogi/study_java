...
var spid_details_vue_1 = require("@/entities/spid/spid-details.vue");
...
describe('Component Tests', function () {
    describe('Spid Management Detail Component', function () {
        var wrapper;
        var comp;
        var spidServiceStub;
        beforeEach(function () {
            spidServiceStub = sinon_1.default.createStubInstance(spid_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(spid_details_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router_1.default,
                provide: { spidService: function () { return spidServiceStub; }, alertService: function () { return new alert_service_1.default(); } },
            });
            comp = wrapper.vm;
        });
