...
var spid_model_1 = require("@/shared/model/spid.model");
var error = {
    response: {
        status: null,
        data: {
...
describe('Service Tests', function () {
    describe('Spid Service', function () {
        var service;
        var elemDefault;
        beforeEach(function () {
            service = new spid_service_1.default();
            elemDefault = new spid_model_1.Spid(123, 0, 'AAAAAAA');
        });
        describe('Service methods', function () {
            ...
            it('should create a Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should not create a Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should update a Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var returnedFromService, expected;
                return __generator(this, function (_a) {
                    returnedFromService = Object.assign({
                        spid: 1,
            ...
            it('should not update a Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should partial update a Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var patchObject, returnedFromService, expected;
                return __generator(this, function (_a) {
                    patchObject = Object.assign({
                        email: 'BBBBBB',
                    }, new spid_model_1.Spid());
            ...
            it('should not partial update a Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should return a list of Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var returnedFromService, expected;
                return __generator(this, function (_a) {
                    returnedFromService = Object.assign({
                        spid: 1,
            ...
            it('should not return a list of Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    axiosStub.get.rejects(error);
                    return [2 /*return*/, service
                            .retrieve()
            ...
            it('should delete a Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should not delete a Spid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
