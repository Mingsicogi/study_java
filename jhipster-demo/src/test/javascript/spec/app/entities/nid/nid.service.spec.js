...
var nid_model_1 = require("@/shared/model/nid.model");
var error = {
    response: {
        status: null,
        data: {
...
describe('Service Tests', function () {
    describe('Nid Service', function () {
        var service;
        var elemDefault;
        beforeEach(function () {
            service = new nid_service_1.default();
            elemDefault = new nid_model_1.Nid(123, 0);
        });
        describe('Service methods', function () {
            ...
            it('should create a Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should not create a Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should update a Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var returnedFromService, expected;
                return __generator(this, function (_a) {
                    returnedFromService = Object.assign({
                        nid: 1,
            ...
            it('should not update a Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should partial update a Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var patchObject, returnedFromService, expected;
                return __generator(this, function (_a) {
                    patchObject = Object.assign({}, new nid_model_1.Nid());
            ...
            it('should not partial update a Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should return a list of Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var returnedFromService, expected;
                return __generator(this, function (_a) {
                    returnedFromService = Object.assign({
                        nid: 1,
            ...
            it('should not return a list of Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    axiosStub.get.rejects(error);
                    return [2 /*return*/, service
                            .retrieve()
            ...
            it('should delete a Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should not delete a Nid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
