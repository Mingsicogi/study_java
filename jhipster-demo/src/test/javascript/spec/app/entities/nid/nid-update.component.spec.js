...
var nid_update_vue_1 = require("@/entities/nid/nid-update.vue");
...
describe('Component Tests', function () {
    describe('Nid Management Update Component', function () {
        var wrapper;
        var comp;
        var nidServiceStub;
        beforeEach(function () {
            nidServiceStub = sinon_1.default.createStubInstance(nid_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(nid_update_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router,
                provide: {
                    nidService: function () { return nidServiceStub; },
