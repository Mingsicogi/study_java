...
var game_update_vue_1 = require("@/entities/game/game-update.vue");
...
describe('Component Tests', function () {
    describe('Game Management Update Component', function () {
        var wrapper;
        var comp;
        var gameServiceStub;
        beforeEach(function () {
            gameServiceStub = sinon_1.default.createStubInstance(game_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(game_update_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router,
                provide: {
                    gameService: function () { return gameServiceStub; },
                    alertService: function () { return new alert_service_1.default(); },
                    gameServerService: function () {
                        return sinon_1.default.createStubInstance(game_server_service_1.default, {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            // WHEN
                            comp.beforeRouteEnter({ params: { gameId: 123 } }, null, function (cb) { return cb(comp); });
                            return [4 /*yield*/, comp.$nextTick()];
                        case 1:
                            _a.sent();
                            // THEN
