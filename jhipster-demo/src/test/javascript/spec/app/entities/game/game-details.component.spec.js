...
var game_details_vue_1 = require("@/entities/game/game-details.vue");
...
describe('Component Tests', function () {
    describe('Game Management Detail Component', function () {
        var wrapper;
        var comp;
        var gameServiceStub;
        beforeEach(function () {
            gameServiceStub = sinon_1.default.createStubInstance(game_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(game_details_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router_1.default,
                provide: { gameService: function () { return gameServiceStub; }, alertService: function () { return new alert_service_1.default(); } },
            });
            comp = wrapper.vm;
        });
