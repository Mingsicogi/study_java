...
var game_server_details_vue_1 = require("@/entities/game-server/game-server-details.vue");
...
describe('Component Tests', function () {
    describe('GameServer Management Detail Component', function () {
        var wrapper;
        var comp;
        var gameServerServiceStub;
        beforeEach(function () {
            gameServerServiceStub = sinon_1.default.createStubInstance(game_server_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(game_server_details_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router_1.default,
                provide: { gameServerService: function () { return gameServerServiceStub; }, alertService: function () { return new alert_service_1.default(); } },
            });
            comp = wrapper.vm;
        });
