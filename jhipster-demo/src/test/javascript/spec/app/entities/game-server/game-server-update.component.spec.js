...
var game_server_update_vue_1 = require("@/entities/game-server/game-server-update.vue");
...
describe('Component Tests', function () {
    describe('GameServer Management Update Component', function () {
        var wrapper;
        var comp;
        var gameServerServiceStub;
        beforeEach(function () {
            gameServerServiceStub = sinon_1.default.createStubInstance(game_server_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(game_server_update_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router,
                provide: {
                    gameServerService: function () { return gameServerServiceStub; },
