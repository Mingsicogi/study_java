...
var game_server_vue_1 = require("@/entities/game-server/game-server.vue");
...
describe('Component Tests', function () {
    describe('GameServer Management Component', function () {
        var wrapper;
        var comp;
        ...
        beforeEach(function () {
            ...
            wrapper = (0, test_utils_1.shallowMount)(game_server_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
