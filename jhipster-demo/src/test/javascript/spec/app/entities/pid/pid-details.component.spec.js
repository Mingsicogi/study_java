...
var pid_details_vue_1 = require("@/entities/pid/pid-details.vue");
...
describe('Component Tests', function () {
    describe('Pid Management Detail Component', function () {
        var wrapper;
        var comp;
        var pidServiceStub;
        beforeEach(function () {
            pidServiceStub = sinon_1.default.createStubInstance(pid_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(pid_details_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router_1.default,
                provide: { pidService: function () { return pidServiceStub; }, alertService: function () { return new alert_service_1.default(); } },
            });
            comp = wrapper.vm;
        });
