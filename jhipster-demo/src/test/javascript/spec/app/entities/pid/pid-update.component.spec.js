...
var pid_update_vue_1 = require("@/entities/pid/pid-update.vue");
...
describe('Component Tests', function () {
    describe('Pid Management Update Component', function () {
        var wrapper;
        var comp;
        var pidServiceStub;
        beforeEach(function () {
            pidServiceStub = sinon_1.default.createStubInstance(pid_service_1.default);
            wrapper = (0, test_utils_1.shallowMount)(pid_update_vue_1.default, {
                store: store,
                i18n: i18n,
                localVue: localVue,
                router: router,
                provide: {
                    pidService: function () { return pidServiceStub; },
                    alertService: function () { return new alert_service_1.default(); },
                    spidService: function () {
                        return sinon_1.default.createStubInstance(spid_service_1.default, {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            entity = { id: 123 };
                            comp.pid = entity;
                            pidServiceStub.update.resolves(entity);
                            // WHEN
                            comp.save();
                        ...
                        case 1:
                            _a.sent();
                            // THEN
                            expect(pidServiceStub.update.calledWith(entity)).toBeTruthy();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            entity = {};
                            comp.pid = entity;
                            pidServiceStub.create.resolves(entity);
                            // WHEN
                            comp.save();
                            return [4 /*yield*/, comp.$nextTick()];
                        case 1:
                            _a.sent();
                            // THEN
                            expect(pidServiceStub.create.calledWith(entity)).toBeTruthy();
                            expect(comp.isSaving).toEqual(false);
                            return [2 /*return*/];
                    }
                });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            pidServiceStub.retrieve.resolves([foundPid]);
                            // WHEN
                            comp.beforeRouteEnter({ params: { pidId: 123 } }, null, function (cb) { return cb(comp); });
                            return [4 /*yield*/, comp.$nextTick()];
                        case 1:
                            _a.sent();
                            // THEN
