...
var pid_model_1 = require("@/shared/model/pid.model");
var error = {
    response: {
        status: null,
        data: {
...
describe('Service Tests', function () {
    describe('Pid Service', function () {
        var service;
        var elemDefault;
        beforeEach(function () {
            service = new pid_service_1.default();
            elemDefault = new pid_model_1.Pid(123, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        describe('Service methods', function () {
            ...
            it('should create a Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should not create a Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should update a Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var returnedFromService, expected;
                return __generator(this, function (_a) {
                    returnedFromService = Object.assign({
                        pid: 1,
            ...
            it('should not update a Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should partial update a Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            it('should not partial update a Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should return a list of Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
                var returnedFromService, expected;
                return __generator(this, function (_a) {
                    returnedFromService = Object.assign({
                        pid: 1,
            ...
            it('should not return a list of Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    axiosStub.get.rejects(error);
                    return [2 /*return*/, service
                            .retrieve()
            ...
            it('should delete a Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
            ...
            it('should not delete a Pid', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
