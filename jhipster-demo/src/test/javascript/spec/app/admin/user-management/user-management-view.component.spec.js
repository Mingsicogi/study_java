...
var user_management_view_vue_1 = require("@/admin/user-management/user-management-view.vue");
var user_management_service_1 = require("@/admin/user-management/user-management.service");
var authority_1 = require("@/shared/security/authority");
...
describe('UserManagementView Component', function () {
    var wrapper;
    var userManagementView;
    beforeEach(function () {
        wrapper = (0, test_utils_1.shallowMount)(user_management_view_vue_1.default, {
            store: store,
            i18n: i18n,
            localVue: localVue,
            provide: { userManagementService: function () { return new user_management_service_1.default(); }, alertService: function () { return new alert_service_1.default(); } },
        });
                ...
                switch (_a.label) {
                    case 0:
                        userData = {
                            ...
                            activated: true,
                            langKey: 'en',
                            authorities: [authority_1.Authority.USER],
                            createdBy: 'admin',
                            createdDate: null,
                            lastModifiedBy: null,
                        ...
                        return [4 /*yield*/, userManagementView.$nextTick()];
                    case 1:
                        _a.sent();
                        // THEN
