...
describe('Metrics Component', function () {
    ...
    var metricsModal;
    beforeEach(function () {
        wrapper = (0, test_utils_1.shallowMount)(metrics_modal_vue_1.default, { store: store, i18n: i18n, localVue: localVue });
        metricsModal = wrapper.vm;
    });
    describe('init', function () {
        it('should count the numbers of each thread type', function () { return __awaiter(void 0, void 0, void 0, function () {
