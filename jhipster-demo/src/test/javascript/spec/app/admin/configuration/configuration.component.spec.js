...
var configuration_vue_1 = require("@/admin/configuration/configuration.vue");
var configuration_service_1 = require("@/admin/configuration/configuration.service");
...
describe('Configuration Component', function () {
    ...
    beforeEach(function () {
        ...
        wrapper = (0, test_utils_1.shallowMount)(configuration_vue_1.default, {
            store: store,
            i18n: i18n,
            localVue: localVue,
            provide: { configurationService: function () { return new configuration_service_1.default(); } },
        });
        configuration = wrapper.vm;
    });
    describe('OnRouteEnter', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // WHEN
                        configuration.init();
                        return [4 /*yield*/, configuration.$nextTick()];
                    case 1:
                        _a.sent();
                        // THEN
    ...
    describe('changeOrder function', function () {
        it('should change order', function () {
            // GIVEN
            var rev = configuration.reverse;
            // WHEN
