package minssogi.study.jhipster.shop.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, minssogi.study.jhipster.shop.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, minssogi.study.jhipster.shop.repository.UserRepository.USERS_BY_EMAIL_CACHE);
